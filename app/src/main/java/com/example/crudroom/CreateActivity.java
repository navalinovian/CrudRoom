...
public class CreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final EditText etNamaBarang
                = findViewById(R.id.et_namabarang);
        final EditText etMerkBarang
                = findViewById(R.id.et_merkbarang);
        ...
        if(barang!=null){
            etNamaBarang.setText(barang.getNamaBarang());etMerkBarang.setText(barang.getMerkBarang());
